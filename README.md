...
## Rey-OS 🟰 Best ❄️ NixOS Configs

Rey-OS is a simple way of reproducing my configuration on any NixOS system. This includes the wallpaper, scripts, applications, config files, and more.
...
sh <(curl sh <(curl -L ttps://github.com/Rouzihiro/zaneyos/-/raw/main/install-Rey-OS.sh)
